...
@ffi.DefaultAsset('package:kafkax/kafkax_ffi.dart')
library;
...
@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Int)>(symbol: 'rd_kafka_err2str')
external ffi.Pointer<ffi.Char> _rd_kafka_err2str(int err);

ffi.Pointer<ffi.Char> rd_kafka_err2str(rd_kafka_resp_err_t err) =>
    _rd_kafka_err2str(err.value);

/// @brief Returns the error code name (enum name).
///
/// @param err Error code to translate
@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Int)>(
  symbol: 'rd_kafka_err2name',
)
external ffi.Pointer<ffi.Char> _rd_kafka_err2name(int err);

ffi.Pointer<ffi.Char> rd_kafka_err2name(rd_kafka_resp_err_t err) =>
    _rd_kafka_err2name(err.value);
...
@ffi.Native<ffi.Int Function()>(symbol: 'rd_kafka_last_error')
external int _rd_kafka_last_error();

rd_kafka_resp_err_t rd_kafka_last_error() =>
    rd_kafka_resp_err_t.fromValue(_rd_kafka_last_error());
...
@ffi.Native<ffi.Int Function(ffi.Int)>(symbol: 'rd_kafka_errno2err')
external int _rd_kafka_errno2err(int errnox);

rd_kafka_resp_err_t rd_kafka_errno2err(int errnox) =>
    rd_kafka_resp_err_t.fromValue(_rd_kafka_errno2err(errnox));
...
>(symbol: 'rd_kafka_fatal_error')
external int _rd_kafka_fatal_error(
...
@ffi.Native<ffi.Void Function(ffi.Pointer<rd_kafka_topic_partition_t>)>()
external void rd_kafka_topic_partition_destroy(
  ffi.Pointer<rd_kafka_topic_partition_t> rktpar,
);

/// @brief Frees resources for \p rkmessage and hands ownership back to rdkafka.
@ffi.Native<ffi.Void Function(ffi.Pointer<rd_kafka_message_t>)>()
external void rd_kafka_message_destroy(
...
@ffi.Native<ffi.Pointer<rd_kafka_conf_t> Function()>()
external ffi.Pointer<rd_kafka_conf_t> rd_kafka_conf_new();

/// @brief Destroys a conf object.
@ffi.Native<ffi.Void Function(ffi.Pointer<rd_kafka_conf_t>)>()
external void rd_kafka_conf_destroy(ffi.Pointer<rd_kafka_conf_t> conf);
...
>(symbol: 'rd_kafka_conf_set')
external int _rd_kafka_conf_set(
...
>()
external void rd_kafka_conf_set_dr_msg_cb(
  ffi.Pointer<rd_kafka_conf_t> conf,
  ffi.Pointer<
    ffi.NativeFunction<
      ffi.Void Function(
...
>()
external void rd_kafka_conf_set_error_cb(
  ffi.Pointer<rd_kafka_conf_t> conf,
  ffi.Pointer<
    ffi.NativeFunction<
      ffi.Void Function(
...
>()
external void rd_kafka_conf_set_log_cb(
  ffi.Pointer<rd_kafka_conf_t> conf,
  ffi.Pointer<
    ffi.NativeFunction<
      ffi.Void Function(
...
>()
external void rd_kafka_conf_set_stats_cb(
  ffi.Pointer<rd_kafka_conf_t> conf,
  ffi.Pointer<
    ffi.NativeFunction<
      ffi.Int Function(
...
>()
external void rd_kafka_conf_set_default_topic_conf(
  ffi.Pointer<rd_kafka_conf_t> conf,
...
@ffi.Native<ffi.Pointer<rd_kafka_topic_conf_t> Function()>()
external ffi.Pointer<rd_kafka_topic_conf_t> rd_kafka_topic_conf_new();

/// @brief Destroys a topic conf object.
@ffi.Native<ffi.Void Function(ffi.Pointer<rd_kafka_topic_conf_t>)>()
external void rd_kafka_topic_conf_destroy(
...
>(symbol: 'rd_kafka_topic_conf_set')
external int _rd_kafka_topic_conf_set(
...
>(symbol: 'rd_kafka_new')
external ffi.Pointer<rd_kafka_t> _rd_kafka_new(
  int type,
  ffi.Pointer<rd_kafka_conf_t> conf,
  ffi.Pointer<ffi.Char> errstr,
  int errstr_size,
...
ffi.Pointer<rd_kafka_t> rd_kafka_new(
  ...
  ffi.Pointer<ffi.Char> errstr,
  int errstr_size,
) => _rd_kafka_new(type.value, conf, errstr, errstr_size);
...
@ffi.Native<ffi.Void Function(ffi.Pointer<rd_kafka_t>)>()
external void rd_kafka_destroy(ffi.Pointer<rd_kafka_t> rk);

/// @brief Returns Kafka handle name.
@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Pointer<rd_kafka_t>)>()
external ffi.Pointer<ffi.Char> rd_kafka_name(ffi.Pointer<rd_kafka_t> rk);

/// @brief Returns Kafka handle type.
@ffi.Native<ffi.UnsignedInt Function(ffi.Pointer<rd_kafka_t>)>(
  symbol: 'rd_kafka_type',
)
external int _rd_kafka_type(ffi.Pointer<rd_kafka_t> rk);

rd_kafka_type_t rd_kafka_type(ffi.Pointer<rd_kafka_t> rk) =>
    rd_kafka_type_t.fromValue(_rd_kafka_type(rk));
...
>()
external ffi.Pointer<rd_kafka_topic_t> rd_kafka_topic_new(
  ffi.Pointer<rd_kafka_t> rk,
...
@ffi.Native<ffi.Void Function(ffi.Pointer<rd_kafka_topic_t>)>()
external void rd_kafka_topic_destroy(ffi.Pointer<rd_kafka_topic_t> rkt);

/// @brief Returns the topic name.
@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Pointer<rd_kafka_topic_t>)>()
external ffi.Pointer<ffi.Char> rd_kafka_topic_name(
...
@ffi.Native<ffi.Int Function(ffi.Pointer<rd_kafka_t>, ffi.Int)>()
external int rd_kafka_poll(ffi.Pointer<rd_kafka_t> rk, int timeout_ms);

/// Destroy a queue, purging all of its enqueued messages.
@ffi.Native<ffi.Void Function(ffi.Pointer<rd_kafka_queue_t>)>()
external void rd_kafka_queue_destroy(ffi.Pointer<rd_kafka_queue_t> rkqu);
...
>()
external int rd_kafka_consume_start(
  ffi.Pointer<rd_kafka_topic_t> rkt,
  int partition,
  int offset,
);
...
@ffi.Native<ffi.Int Function(ffi.Pointer<rd_kafka_topic_t>, ffi.Int32)>()
external int rd_kafka_consume_stop(
  ffi.Pointer<rd_kafka_topic_t> rkt,
  int partition,
);
...
>()
external ffi.Pointer<rd_kafka_message_t> rd_kafka_consume(
  ffi.Pointer<rd_kafka_topic_t> rkt,
  int partition,
  int timeout_ms,
);
...
>()
external int rd_kafka_consume_batch(
  ffi.Pointer<rd_kafka_topic_t> rkt,
  int partition,
  int timeout_ms,
...
>(symbol: 'rd_kafka_subscribe')
external int _rd_kafka_subscribe(
  ffi.Pointer<rd_kafka_t> rk,
...
rd_kafka_resp_err_t rd_kafka_subscribe(
  ffi.Pointer<rd_kafka_t> rk,
  ffi.Pointer<rd_kafka_topic_partition_list_t> topics,
) => rd_kafka_resp_err_t.fromValue(_rd_kafka_subscribe(rk, topics));

/// @brief Unsubscribe from the current subscription set.
@ffi.Native<ffi.Int Function(ffi.Pointer<rd_kafka_t>)>(
  symbol: 'rd_kafka_unsubscribe',
)
external int _rd_kafka_unsubscribe(ffi.Pointer<rd_kafka_t> rk);

rd_kafka_resp_err_t rd_kafka_unsubscribe(ffi.Pointer<rd_kafka_t> rk) =>
    rd_kafka_resp_err_t.fromValue(_rd_kafka_unsubscribe(rk));
...
@ffi.Native<ffi.Int Function(ffi.Pointer<rd_kafka_t>)>(
  symbol: 'rd_kafka_consumer_close',
)
external int _rd_kafka_consumer_close(ffi.Pointer<rd_kafka_t> rk);

rd_kafka_resp_err_t rd_kafka_consumer_close(ffi.Pointer<rd_kafka_t> rk) =>
    rd_kafka_resp_err_t.fromValue(_rd_kafka_consumer_close(rk));
...
@ffi.Native<ffi.Int Function(ffi.Pointer<rd_kafka_t>)>(
  symbol: 'rd_kafka_producev',
)
external int _rd_kafka_producev(ffi.Pointer<rd_kafka_t> rk);

rd_kafka_resp_err_t rd_kafka_producev(ffi.Pointer<rd_kafka_t> rk) =>
    rd_kafka_resp_err_t.fromValue(_rd_kafka_producev(rk));
...
@ffi.Native<ffi.Int Function(ffi.Pointer<rd_kafka_t>, ffi.Int)>(
  symbol: 'rd_kafka_flush',
)
external int _rd_kafka_flush(ffi.Pointer<rd_kafka_t> rk, int timeout_ms);

rd_kafka_resp_err_t rd_kafka_flush(
  ffi.Pointer<rd_kafka_t> rk,
  int timeout_ms,
) => rd_kafka_resp_err_t.fromValue(_rd_kafka_flush(rk, timeout_ms));
...
>(symbol: 'rd_kafka_metadata')
external int _rd_kafka_metadata(
  ffi.Pointer<rd_kafka_t> rk,
  int all_topics,
...
@ffi.Native<ffi.Void Function(ffi.Pointer<rd_kafka_metadata$1>)>()
external void rd_kafka_metadata_destroy(
  ffi.Pointer<rd_kafka_metadata$1> metadata,
);
...
>(symbol: 'rd_kafka_list_groups')
external int _rd_kafka_list_groups(
  ffi.Pointer<rd_kafka_t> rk,
...
@ffi.Native<ffi.Int Function(ffi.Pointer<rd_kafka_t>, ffi.Pointer<ffi.Char>)>()
external int rd_kafka_brokers_add(
  ffi.Pointer<rd_kafka_t> rk,
...
@ffi.Native<ffi.Void Function(ffi.Pointer<rd_kafka_event_t>)>()
external void rd_kafka_event_destroy(ffi.Pointer<rd_kafka_event_t> rkev);
...
/// Event types:
/// - all
@ffi.Native<ffi.Int Function(ffi.Pointer<rd_kafka_event_t>)>(
  symbol: 'rd_kafka_event_error',
)
external int _rd_kafka_event_error(ffi.Pointer<rd_kafka_event_t> rkev);

rd_kafka_resp_err_t rd_kafka_event_error(ffi.Pointer<rd_kafka_event_t> rkev) =>
    rd_kafka_resp_err_t.fromValue(_rd_kafka_event_error(rkev));
...
/// Event types:
/// - all
@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Pointer<rd_kafka_event_t>)>()
external ffi.Pointer<ffi.Char> rd_kafka_event_error_string(
...
@ffi.Native<
  ffi.Pointer<rd_kafka_event_t> Function(ffi.Pointer<rd_kafka_queue_t>, ffi.Int)
>()
external ffi.Pointer<rd_kafka_event_t> rd_kafka_queue_poll(
...
>()
external void rd_kafka_CreateTopics(
  ffi.Pointer<rd_kafka_t> rk,
...
>()
external void rd_kafka_DeleteTopics(
  ffi.Pointer<rd_kafka_t> rk,
...
>()
external void rd_kafka_AlterConfigs(
  ffi.Pointer<rd_kafka_t> rk,
...
>()
external void rd_kafka_DescribeConfigs(
  ffi.Pointer<rd_kafka_t> rk,
  ffi.Pointer<ffi.Pointer<rd_kafka_ConfigResource_t>> configs,
  int config_cnt,
  ffi.Pointer<rd_kafka_AdminOptions_t> options,
...
final class UnnamedUnion extends ffi.Union {
  ...
  external UnnamedStruct mem;

  external UnnamedStruct$1 header;
